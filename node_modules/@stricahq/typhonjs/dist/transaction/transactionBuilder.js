...
function transactionBuilder({ transaction, inputs, changeAddress, collateralInputs = [], }) {
    ...
    const minUtxo = (0, utils_1.calculateMinUtxoAmount)([], new bignumber_js_1.default(transaction.protocolParams.lovelacePerUtxoWord));
    ...
    for (const utxo of utxoInputs) {
        ...
        if (tokenDiff.length === 0) {
            ...
            const tokensTokens = (0, utils_1.getMaximumTokenSets)(tokenDiff);
            const changeOutputs = [];
            ...
            for (const [index, tokens] of tokensTokens.entries()) {
                const minUtxo = (0, utils_1.calculateMinUtxoAmount)(tokens, new bignumber_js_1.default(transaction.protocolParams.lovelacePerUtxoWord));
    ...
    if (tokenDiff.length === 0) {
        ...
        const tokensTokens = (0, utils_1.getMaximumTokenSets)(_.clone(tokenDiff));
        const changeOutputs = [];
        {
