...
import { PlutusData, CollateralInput, LanguageView, AuxiliaryData, Certificate, Input, Metadata, Output, StakeDelegationCertificate, StakeDeRegistrationCertificate, StakeRegistrationCertificate, Token, VKeyWitness, Withdrawal, PlutusScriptType, NativeScript, Mint } from "../types";
import { EncodedCertificate, EncodedCollateralInput, EncodedPlutusData, EncodedInput, EncodedOutput, EncodedPlutusScript, EncodedStakeDelegationCertificate, EncodedStakeDeRegistrationCertificate, EncodedStakeRegistrationCertificate, EncodedTokens, EncodedVKeyWitness, EncodedWithdrawals, EncodedWitnesses, EncodedNativeScript } from "../internal-types";
export declare const encodeInputs: (inputs: Array<Input>) => Array<EncodedInput>;
...
export declare const encodeLanguageViews: (languageView: LanguageView, encodedPlutusScripts?: Array<EncodedPlutusScript>) => string;
