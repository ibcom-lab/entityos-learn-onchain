...
const generateScriptDataHash = (witnesses, languageView) => {
    ...
    if (encodedPlutusDataList || encodedRedeemers) {
        const encodedPlutusScripts = witnesses.get(types_1.WitnessType.PLUTUS_SCRIPT);
        const langViewCbor = (0, encoder_1.encodeLanguageViews)(languageView, encodedPlutusScripts);
