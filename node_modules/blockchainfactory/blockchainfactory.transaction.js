...
module.exports =
{
	...
	init: function (param)
	{
        mydigitalstructure.add(
            {
                name: 'blockchain-transaction-create',
                code: function ()
                {
                    mydigitalstructure.invoke('blockchain-transaction-create-metadata');   
                }	
            });		

		mydigitalstructure.add(
		{
			name: 'blockchain-transaction-create-metadata',
			code: function ()
			{
                ...
                if (event.sourceDataFileName != undefined)
                {
                    mydigitalstructure.invoke('util-get-from-file',
                    {
                        ...
                        onComplete: 'blockchain-transaction-create-metadata-process'
                    })
                }
            }	
		});		
        ...
        mydigitalstructure.add(
        {
            name: 'blockchain-transaction-create-metadata-process',
            code: function (param)
            {
                var event = mydigitalstructure.get({scope: '_event'});

                event.fileData = mydigitalstructure._util.param.get(param, 'fileData').value;
                ...
                var sourceData = mydigitalstructure.invoke('util-as-object',
                {
                ...
                _.each(sourceData, function (_sourceData, sd)
                {
                    ...
                    {
                        _sourceData._sdi = mydigitalstructure.invoke('util-text-replace-all', 
                        {
                        ...
                        _sourceData._assetName =  mydigitalstructure.invoke('util-text-to-hex',
                        {
                ...
                mydigitalstructure.invoke('util-save-to-file',
                {
                    ...
                    onComplete: 'blockchain-transaction-create-unsigned'
                });
            }
        });
        ...
        mydigitalstructure.add(
        {
            name: 'blockchain-transaction-create-unsigned',
            code: function (param)
            {
                var event = mydigitalstructure.get({scope: '_event'});
                ...
                mydigitalstructure.invoke('util-save-to-file',
                {
                    ...
                    onComplete: 'blockchain-transaction-create-html'
                });
        ...
        mydigitalstructure.add(
        {
            name: 'blockchain-transaction-create-html',
            code: function (param)
            {
                var event = mydigitalstructure.get({scope: '_event'});
